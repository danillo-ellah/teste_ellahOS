...
import type { AgencyFilters as AgencyFiltersType } from '@/types/clients'

interface AgencyFiltersProps {
  filters: AgencyFiltersType
  onFiltersChange: (filters: AgencyFiltersType) => void
}

export function AgencyFilters({ filters, onFiltersChange }: AgencyFiltersProps) {
