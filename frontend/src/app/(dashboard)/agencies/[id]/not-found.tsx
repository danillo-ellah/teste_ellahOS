...
export default function AgencyNotFound() {
  return (
    <div className="py-24 flex flex-col items-center justify-center text-center gap-4">
      ...
      <h2 className="text-lg font-semibold">Agencia nao encontrada</h2>
      <p className="text-sm text-muted-foreground max-w-[300px]">
        Esta agencia nao existe ou voce nao tem permissao para acessa-la.
      </p>
      <Button asChild variant="outline" className="mt-4">
        <Link href="/agencies">Voltar para Agencias</Link>
      </Button>
    </div>
  )
}
