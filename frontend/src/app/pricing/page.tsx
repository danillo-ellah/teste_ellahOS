...
const plans: Plan[] = [
  ...
  },
  {
    ...
    priceNote: '',
    description:
      'Para grupos e redes de producao com necessidades avancadas e SLA garantido.',
    features: [
      'Usuarios ilimitados',
      'Tudo do plano Pro',
      'SSO / SAML',
      'Importacao de dados',
      'Integracao contabil (Omie, Conta Azul)',
      'SLA 99.9% garantido',
      'Suporte dedicado + onboarding assistido',
    ],
    cta: 'Falar com vendas',
    ctaHref: 'mailto:comercial@ellahfilmes.com',
    highlighted: false,
  },
]
...
const faqItems: FaqItem[] = [
  {
    ...
    answer:
      'Sim. Os planos Starter e Pro incluem 14 dias de teste gratuito, sem necessidade de cartao de credito. Voce so e cobrado apos o periodo de teste.',
  },
  {
